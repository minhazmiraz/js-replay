        ...
        playback: (function () {
			...
			*/
            var verifyContains = function (userEvent) {
                var elementText =
                    $(userEvent.selector).val() ||
                    $(userEvent.selector)[0].innerHTML;
			...
			*/
            var constructor = function (playbackJson) {
				...
				*/
                ...
                //                 this.window = playbackData.window;
                //                 console.log(
                //                     "window data: ",
                //                     playbackData.window
                //                 );
                //             } else {
                //                 throw new Error(
                //                     "Playback JSON file does not contain required window attributes."
                //                 );
                //             }
                ...
                //             } else {
                //                 throw new Error(
                //                     "Event log in the JSON playback file is not an array."
                //                 );
                //             }
                //         } else {
                //             throw new Error(
                //                 "Received an invalid playback JSON file."
                //             );
                //         }
                //     },
                //     error: function (jqXHR, textStatus, errorThrown) {
                //         throw new Error(
                //             "Failed to retrieve the playback JSON file."
                //         );
                //     },
                //     dataType: "json",
                // });
        ...
        record: (function () {
			...
			*/
            ...
            document.addEventListener(
                ...
                function (event) {
                    logEvent(
                        $.extend(true, event, { value: $(event.target).val() })
                    );
                },
                true
            );
